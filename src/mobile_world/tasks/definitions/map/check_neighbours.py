...
class GoogleMapsAlibabaSouthNeighborTask(BaseTask):
    """Use Google Maps to find the company directly south of Alibaba Hangzhou headquarters."""

    goal = (
        "Open Google Maps and find which company is directly south of Alibaba Hangzhou headquarters in Binjiang District. "
