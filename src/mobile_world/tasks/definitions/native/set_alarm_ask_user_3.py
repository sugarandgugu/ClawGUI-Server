...
class SetAlarmTaskAskUser3(BaseTask):
    task_tags = {"agent-user-interaction", "lang-en"}

    goal = "Please set a morning wake-up alarm for my weekend at 9:45 p.m. Choose the ringtone 'beebeep' for the alarm."
    ...
    def initialize_task_hook(self, controller: AndroidController) -> bool:
        ...
        self.relevant_information = "I just gave the incorrect information by mistake, the alarm should be set for 9:45 AM on weekend."
        return True
