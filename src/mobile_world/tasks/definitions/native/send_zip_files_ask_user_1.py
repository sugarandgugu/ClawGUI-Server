...
class SendZipFilesAskUserTask1(BaseTask):
    """Send zip files task - compress files from past three months and send via email."""

    task_tags = {"agent-user-interaction", "lang-en"}
    goal = 'Compress all downloaded files in the "Download" folder from the past three months into a single file, renamed as "documents.zip", email it to Kevin using `Mail` app with the list of compressed files, seprated by comma. No other text.'

    EMAIL_ADDRESS = "kevin_zhang@example.com"
    # Email should contain list of compressed files, comma separated
    EXPECTED_EMAIL_FILES = [
        "28_report_Q4_2025.zip",
        "24_screenshots_sep_2025.zip",
        "27_camera_backup_20250905.zip",
        "25_archive_20250821.zip",
    ]
