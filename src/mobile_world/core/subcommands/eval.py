...
def _add_common_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        dest="google_only",
        action="store_true",
        help="Only run Google-related tasks (Apps containing Chrome/Maps). If not set, Google tasks are excluded.",
    )
    parser.add_argument(
        "--scale-factor",
        "--scale_factor",
    ...
    parser.add_argument(
        ...
        dest="resize_image",
        action="store_true",
        help="Enable image resizing before sending to model (default: False)",
    )
    parser.add_argument(
        "--resize-resolution",
        "--resize_resolution",
        ...
        type=str,
        default="720x1600",
        help="Target resolution for image resizing, format: WIDTHxHEIGHT (default: 720x1600)",
    )
...
async def execute(args: argparse.Namespace) -> None:
    ...
    task_results, task_list_with_no_results = run_agent_with_evaluation(
        ...
        resize_image=getattr(args, "resize_image", False),
        resize_resolution=getattr(args, "resize_resolution", "720x1600"),
    )
